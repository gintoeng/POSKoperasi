...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Autodebet Waserda</li>
    </ol>
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <form method="post" action="{!! url('akuntansi/autodebet/waserda') !!}" id="fautopinj" enctype="multipart/form-data">
                        <section class="panel">
                                    ...
                                    <table id="tabauto" class="table table-bordered table-striped no-m scroll" style="height:800px; display: -moz-groupbox;">
                                        ...
                                        @foreach($auto as $tampil)
                                            ...
                                            <tr style="width: 100%;display: inline-table;table-layout: fixed;">
                                                ...
                                                <td>{!! $tampil->trandetailid->no_ref !!}</td>
                                                <td>{!! $anggota->nama !!}</td>
    ...
    <script>
        ...
        $('#btnsub').on('click', function() {
            $.ajax({
                url: "{!! url('akuntansi/autodebet/waserda/cek') !!}",
                data: {},
                dataType: "json",
                type: "get",
                success:function(data)
        ...
        $('#btndown').on('click', function () {
            ...
            if ($('#shu').val() == "") {
                ...
                location.href = "{!! url('akuntansi/autodebet/waserda/download') !!}/" + b + "/" + t  + "/" + shu + "/" + df + "/" + dt;
            }
        });
    </script>
