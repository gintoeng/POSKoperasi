	...
	<div class="col-md-12">
		<section class="panel no-b">
			<div class="panel-body">
				<div class="row">
					<form class="form-horizontal" role="form" method="get" action="{!! url('akuntansi/jurnal/search') !!}">
						<div class="col-md-6">
						...
						<div class="col-md-6">
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<button type="submit" class="btn btn-sm btn-primary"><i class="ti-search mr5"></i>Cari</button>
									</div>
								</div>
						</div>
					</form>
								...
								<div class="tab-pane fade active in" id="manual">
									<div class="row">
										<div class="col-md-6">
											...
											<a target="_blank" href="{{url('akuntansi/jurnal/cetak/Manual/'.$status.'?kata_kunci='.$kata_kunci.'&'.'akun_perkiraan='.$akun_perkiraan.'&'.'posting='.$posting.'&'.'datefrom='.$date1.'&'.'dateto='.$date2)}}" class="btn btn-sm btn-info mb5"><i class="ti-printer mr5"></i>Cetak</a>
										</div>
										<div class="col-md-6">
											<div class="pull-right">
												Total data dalam semua transaksi : {!! $JurnalHeaderManualjml !!}
											</div>
										</div>
									</div>
									<div class="row">
											...
											<div class="table-responsive no-border">
						                        <table class="table table-bordered table-striped mg-t">
						                            ...
						                            <tbody>
						                            	...
						                            	@else
        						                            <?php
                                                                $i = ($JurnalHeaderManual->currentPage() - 1) * $JurnalHeaderManual->perPage() + 1;
            							                            ...
            							                            <tr>
                                                                        <?php
                                                                            if($row['kode_jurnal'] != $prev_kode_jurnalManual){
                                                                                echo '<td class="text-center" rowspan="'.$total_detailManual.'">'.$i++.'.</td>';
                                                ...
                                                <div class="row">
                                                        <div class="col-md-11">
                                                            <div class="form-group pull-right">
                                                                @if($status=="index")
                                                                {{ $JurnalHeaderManual->links() }}
                                                                @elseif($status=="cari")
                                                                {!! str_replace('?','?kata_kunci='.$kata_kunci.'&'.'akun_perkiraan='.$akun_perkiraan.'&'.'posting='.$posting.'&'.'datefrom='.$date1.'&'.'dateto='.$date2.'&',$JurnalHeaderManual->links()) !!}
                                                                @endif
                            								</div>
                                                        </div>
                                						<div class="col-md-1">
