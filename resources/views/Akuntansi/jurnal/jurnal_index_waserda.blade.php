        ...
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <div class="row">
                        <form class="form-horizontal" role="form" method="get" action="{!! url('akuntansi/jurnal/search/waserda') !!}">
                            <div class="col-md-6">
                            ...
                            <div class="box-tab">
                                <ul class="nav nav-tabs">
                                    @if($status=="index")
                                        ...
                                        <li class="active"><a href="#waserda" data-toggle="tab">Waserda</a></li>
                                    @elseif($status=="cari")
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade active in" id="waserda">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <a target="_blank" href="{{url('akuntansi/jurnal/cetak/Waserda/'.$status.'?kata_kunci='.$kata_kunci.'&'.'akun_perkiraan='.$akun_perkiraan.'&'.'posting='.$posting.'&'.'datefrom='.$date1.'&'.'dateto='.$date2)}}" class="btn btn-sm btn-info mb5"><i class="ti-printer mr5"></i>Cetak</a>
                                            </div>
                                            <div class="col-md-6">
