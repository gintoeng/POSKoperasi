	...
	<div class="col-md-12">
		<section class="panel no-b">
			<div class="panel-body">
				<div class="row">
					<form class="form-horizontal" role="form" method="get" action="{!! url('akuntansi/jurnal/search/semua') !!}">
						<div class="col-md-6">
					...
					<div class="col-md-12">
						<div class="box-tab">
							<ul class="nav nav-tabs">
                                @if($status=="index")
                                <li class="active"><a href="#All" data-toggle="tab">Semua</a></li>
							...
							<div class="tab-content">
								<div class="tab-pane fade active in" id="All">
									<div class="row">
										<div class="col-md-6">
											<a target="_blank" href="{{url('akuntansi/jurnal/cetak/Semua/'.$status.'?kata_kunci='.$kata_kunci.'&'.'akun_perkiraan='.$akun_perkiraan.'&'.'posting='.$posting.'&'.'datefrom='.$date1.'&'.'dateto='.$date2)}}" class="btn btn-sm btn-info mb5"><i class="ti-printer mr5"></i>Cetak</a>
										</div>
										<div class="col-md-6">
											<div class="pull-right">
												Total data dalam semua transaksi : {!! $JurnalHeaderAlljml !!}
											</div>
										</div>
									</div>
									<div class="row">
											...
											<div class="table-responsive no-border">
						                        <table class="table table-bordered table-striped mg-t">
						                            ...
						                            <tbody>
						                            	...
						                            	@else
        						                            <?php
                                                                $i = ($JurnalHeaderAll->currentPage() - 1) * $JurnalHeaderAll->perPage() + 1;
                                                                $prev_kode_jurnalAll = '';
                                                            ?>
            							                            ...
            							                            <tr>
                                                                        <?php
                                                                            if($row['kode_jurnal'] != $prev_kode_jurnalAll){
                                                                                echo '<td class="text-center" rowspan="'.$total_detailAll.'">'.$i++.'.</td>';
                                                ...
                                                <div class="row">
                                                        <div class="col-md-11">
                                                            <div class="form-group pull-right">
                                                                ...
                                                                @elseif($status=="cari")
                                                                {!! str_replace('?','?kata_kunci='.$kata_kunci.'&'.'akun_perkiraan='.$akun_perkiraan.'&'.'posting='.$posting.'&'.'datefrom='.$date1.'&'.'dateto='.$date2.'&',$JurnalHeaderAll->links()) !!}
                                                                @endif
                            								</div>
                                                        </div>
                                						<div class="col-md-1">
