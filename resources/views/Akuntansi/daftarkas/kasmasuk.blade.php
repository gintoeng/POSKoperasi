...
<div class="row">
	<div class="col-md-12">
        <section class="panel no-b">
            <form class="form-horizontal" role="form" method="post" action="{{ url('akuntansi/kasmasuk/store') }}" onsubmit="return validasitrue();">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="parent" class="col-sm-3 control-label">Masuk Ke Akun</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="kode" readonly class="form-control" id="" value="{{$kode}}">
                                    </div>
                                </div>
    						</div>
    						<div class="col-md-6">
...
<div class="modal fade" id="rejectModal1" tabindex="-1" role="dialog" aria-labelledby="rejectModalLabel">
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <div class="modal-body">
		  <p>Format nomor untuk Kas Masuk belum disetting</p>
	  </div>
      <div class="modal-footer">
...
<script type="text/javascript">
    ...
    function ceknomor(){
        $.ajax({
            url: "{!! url('akuntansi/kasmasuk/ceknomor') !!}",
            data: {},
            dataType: "json",
            type: "get",
