...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">{!! $aset->kode_aset !!}</li>
    </ol>
    <div class="row">
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="post" action="{!! url('akuntansi/penyusutan/update/'.$aset->id.'/aset') !!}" id="fased">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="kode" type="text" class="form-control" id="kode" value="{!! $aset->kode_aset !!}" placeholder="Kode Aset" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="nama" class="col-sm-3 control-label">Nama Aset</label>
                                                <div class="col-sm-9">
                                                    <input name="nama" type="text" class="form-control" id="nama" value="{!! $aset->nama_aset !!}" placeholder="Nama Aset" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="harga" class="col-sm-3 control-label">Harga</label>
                                                <div class="col-sm-9">
                                                    <input name="harga" type="text" class="form-control" id="harga" style="text-align:right" value="{!! number_format($aset->nominal_harga, 2, '.', ',') !!}" placeholder="0.00" onkeyup="susut()">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="spinner input-group">
                                                        <input name="bulan_penyusutan" type="text" class="form-control input-sm spinner-input" id="bulansusut" value="{!! $aset->bulan !!}" placeholder="0" onkeyup="susut()">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="penyusutan" type="text" class="form-control" id="penyusutan" style="text-align:right" value="{!! number_format($aset->penyusutan, 2, '.', ',') !!}" placeholder="0.00" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="akun_kas" style="width:100%;" id="akun-kas" data-placeholder="Pilih Akun Kas" class="form-control" required>
                                                        ...
                                                        @foreach($perkiraan as $value)
                                                            <option style="width: 100%" value="{!! $value->id !!}" {!! $aset->akun_kas == $value->id ? 'selected' : ''!!}>{!! $value->kode_akun !!} - {!! $value->nama_akun !!}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="akun_aset" style="width:100%;" id="akun-aset" data-placeholder="Pilih Akun Aset" class="form-control" required>
                                                        <!--<option value=""></option>-->
                                                        @foreach($perkiraan as $value)
                                                            <option value="{!! $value->id !!}" {!! $aset->akun_aset == $value->id ? 'selected' : ''!!}>{!! $value->kode_akun !!} - {!! $value->nama_akun !!}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="akun_biaya" style="width:100%;" id="akun-biaya" data-placeholder="Pilih Akun Biaya Penyusutan" class="form-control" required>
                                                        <!--<option value=""></option>-->
                                                        @foreach($perkiraan as $value)
                                                            <option value="{!! $value->id !!}" {!! $aset->akun_biaya_penyusutan == $value->id ? 'selected' : ''!!}>{!! $value->kode_akun !!} - {!! $value->nama_akun !!}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="akun_akumulasi" style="width:100%;" id="akun-akumulasi" data-placeholder="Pilih Akun Akumulasi Penyusutan" class="form-control" required>
                                                        <!--<option value=""></option>-->
                                                        @foreach($perkiraan as $value)
                                                            <option value="{!! $value->id !!}" {!! $aset->akun_akumulasi_penyusutan == $value->id ? 'selected' : ''!!}>{!! $value->kode_akun !!} - {!! $value->nama_akun !!}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="akun_keuntungan" style="width:100%;" id="akun-keuntungan" data-placeholder="Pilih Akun Keuntungan Aset" class="form-control" required>
                                                        <!--<option value=""></option>-->
                                                        @foreach($perkiraan as $value)
                                                            <option value="{!! $value->id !!}" {!! $aset->akun_keuntungan_aset == $value->id ? 'selected' : ''!!}>{!! $value->kode_akun !!} - {!! $value->nama_akun !!}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="akun_kerugian" style="width:100%;" id="akun-kerugian" data-placeholder="Pilih Akun Kerugian Aset" class="form-control" required>
                                                        <!--<option value=""></option>-->
                                                        @foreach($perkiraan as $value)
                                                            <option value="{!! $value->id !!}" {!! $aset->akun_kerugian_aset == $value->id ? 'selected' : ''!!}>{!! $value->kode_akun !!} - {!! $value->nama_akun !!}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
