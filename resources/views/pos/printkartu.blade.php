...
<div style="background:;height:5%;width:100%;margin-top:37%;margin-left:5%;position:absolute;font-size:8pt">Jenis Pembayaran&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: Kartu</div>
   ...
   <div class="col-md-6 col-sm-6 col-xs-12" style="margin-top:45%; margin-left:0%; width:100%;height:5%;">
                           ...
                           <!-- </div>-->
<div style="position:absolute;margin-top:7%;margin-left:-18%">------------------------------------------------------------------------------</div>
<div style="position:absolute;margin-top:25%;margin-left:-18%">------------------------------------------------------------------------------</div>
<div style="margin-top:0%;margin-left:50%;position:absolute;font-size:8pt">Total &nbsp;&nbsp;:</div>
{{--<div style="margin-top:12%;margin-left:0%;position:absolute;font-size:8pt">Saldo &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</div>--}}
<div style="margin-top:22%;margin-left:0%;position:absolute;font-size:8pt">Sisa Saldo :</div>
<div style="margin-top:0%;margin-left:67%;position:absolute;font-size:8pt">Rp. {!! number_format($totalnya ,2,",",".") !!}</div>
{{--<div style="margin-top:12%;margin-left:25%;position:absolute;font-size:8pt">Rp. {!! number_format($saldonya ,2,",",".") !!}</div>--}}
<div style="margin-top:22%%;margin-left:25%;position:absolute;font-size:8pt">Rp. {!! number_format($saldonya ,2,",",".") !!}</div>
</div>
