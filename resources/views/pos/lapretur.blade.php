...
<a onclick="FunctionLoading()" href="{!!url('/pos/laporan/transaksi')!!}">
    ...
    <div style="height:80px; margin-top:50px;float:left; margin-left:90px; position:absolute;color:#3498db;font-size:50px">&nbsp;<b>Retur Penjualan</b></div>
...
<div style="width:100%; height:100%; margin: 0 auto; background-color:#FFF">
    ...
    <input id="bzz" type="hidden" value="{{ $produk  }}">
    <input id="bzzz" type="hidden" value="{{ $bzzz  }}">
    ...
    <div style="font-size:16px;position:absolute;margin-left:4%;width:22.5%;margin-top:12.5%">
            ...
            <div id="table-scroll6" style="width:100%;margin-left:-0.1%">
                ...
                <table id="table" class="display dataTable table table-hover" cellspacing="0" style="margin-top:0px; margin-left:0px;width:100%;position:relative;background:white;">
                    ...
                    <tr style="background:#3498db; color: white; font-size:20px;">
                        ...
                        <td align="center"><b>Qty Retur</b></td>
                    ...
                    @foreach($detail as $value)
                        <tr style="background-color: white; font-size:17px; color:black;">
                            ...
                            <td align="center">{!! $value->no_ref !!}</td>
    ...
    $('#idksr').on('change', function() {
        ...
        $('#pdf').on('click', function () {
            ...
            if($('#bzz').val()=="")
            {
                ...
                window.open("{!! url('pos/laporan/penjualan/retur/barang/hari/pdf') !!}/"+ df + "/" + dt + "/" + $('#cabangnya').val() + "/" + $('#jenisnya').val());
                location.href="{{ url('pos/laporan/retur/penjualan')  }}";
            }
            else
            {
                window.open("{!! url('pos/laporan/penjualan/retur/hari/pdf') !!}/" + $('#bzz').val() + "/" + df + "/" + dt + "/" + $('#cabangnya').val() + "/" + $('#jenisnya').val());
                location.href="{{ url('pos/laporan/retur/penjualan')  }}";
        ...
        $('#pdf1').on('click', function () {
            ...
            if($('#bzz').val()=="")
            {
                window.open("{!! url('pos/laporan/penjualan/retur/barang/bulan/pdf') !!}/" + df + "/" + dt + "/" + $('#cabangnya').val() + "/" + $('#jenisnya').val());
                location.href="{{ url('pos/laporan/retur/penjualan')  }}";

            }
            else
            {
                window.open("{!! url('pos/laporan/penjualan/retur/bulan/pdf') !!}/" + $('#bzz').val() + "/" + df + "/" + dt + "/" + $('#cabangnya').val() + "/" + $('#jenisnya').val());
                location.href="{{ url('pos/laporan/retur/penjualan')  }}";
            }
        ...
        $('#pdf2').on('click', function () {
            ...
            if ($('#bzz').val()=="")
            {
                window.open("{!! url('pos/laporan/penjualan/retur/barang/tahun/pdf') !!}/" + df + "/" + dt + "/" + $('#cabangnya').val() + "/" + $('#jenisnya').val());
                location.href="{{ url('pos/laporan/retur/penjualan')  }}";
            }
            else
            {
                window.open("{!! url('pos/laporan/penjualan/retur/tahun/pdf') !!}/" + $('#bzz').val() + "/" + df + "/" + dt + "/" + $('#cabangnya').val() + "/" + $('#jenisnya').val());
                location.href="{{ url('pos/laporan/retur/penjualan')  }}";
            }
            ...
            $('#btnok1').on('click', function () {
                ...
                if ($('#nama').val()=="")
                {
                    ...
                    location.href = "{!! url('pos/laporan/penjualan/retur/barang/hari') !!}/" + dfrom + "/" + dto + "/" + $('#idkasi').val() + "/" + $('#idkasirr').val();
                ...
                else
                {
                    ...
                    location.href = "{!! url('pos/laporan/penjualan/retur/hari') !!}/" + $('#nama').val() + "/" + dfrom + "/" + dto + "/" + $('#idkasi').val() + "/" + $('#idkasirr').val();
            ...
            $('#btnok2').on('click', function () {
                if ($('#nama').val()=="")
                {
                    ...
                    location.href = "{!! url('pos/laporan/penjualan/retur/barang/bulan') !!}/" + df + "/" + dt + "/" + $('#idkasi').val() + "/" + $('#idkasirr').val();
                ...
                else
                {
                    ...
                    var df = $('#datepickerr1').val();
                    var dt = $('#datepickerr2').val();
                    location.href = "{!! url('pos/laporan/penjualan/retur/bulan') !!}/" + $('#nama').val() + "/" + df + "/" + dt +  "/" + $('#idkasi').val() + "/" + $('#idkasirr').val();
            ...
            $('#btnok3').on('click', function () {
                if ($('#nama').val()=="")
                {
                    ...
                    location.href = "{!! url('pos/laporan/penjualan/retur/barang/tahun') !!}/" + df + "/" + dt + "/" + $('#idkasi').val() + "/" + $('#idkasirr').val();
                ...
                else
                {
                    var df = $('#datepickerrr1').val();
                    var dt = $('#datepickerrr2').val();
                    location.href = "{!! url('pos/laporan/penjualan/retur/tahun') !!}/" + $('#nama').val() + "/" + df + "/" + dt + "/" + $('#idkasi').val() + "/" + $('#idkasirr').val();
