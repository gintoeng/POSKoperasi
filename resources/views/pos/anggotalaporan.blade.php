...
<div style="height:80px; margin-top:50px;float:left; margin-left:90px; position:absolute;color:#3498db;font-size:50px">&nbsp;<b>Transaksi Anggota</b></div>
                        ...
                        <table id="table" class="display dataTable table table-hover" cellspacing="0" style="margin-top:0px; margin-left:0px;width:100%;position:relative;background:white;">
                            ...
                            @foreach($detail as $value)
                                <tr style="background-color: white; font-size:17px; color:black;">
                                    ...
                                    <td align="center">
                                        <a href="{{ url('pos/anggota/detail/'.$value->noref.'/'.$value->no_kartu)  }}"><button style="margin-top:0;width:70px;height:20px;background:#3698db;font-size:15px;color:#FFF;border:none;"><b>Detail</b></button></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
...
<script>
    ...
    if (kasir=="Semua Anggota")
    {
        ...
        $('#pdf').on('click', function () {
            ...
            window.open("{!! url('pos/laporan/periodik/allkasir/anggota/pdf/hari') !!}/"+ df + "/" + dt + "/" + $('#cabangnya').val() + "/" + $('#jenisnya').val());
            location.href="{{ url('pos/laporan/penjualan')  }}";
        });
        $('#pdf1').on('click', function () {
            ...
            window.open("{!! url('pos/laporan/periodik/allkasir/anggota/pdf/bulan') !!}/"+ df + "/" + dt + "/" + $('#cabangnya').val() + "/" + $('#jenisnya').val());
            location.href="{{ url('pos/laporan/penjualan')  }}";
        });
        $('#pdf2').on('click', function () {
            ...
            window.open("{!! url('pos/laporan/periodik/allkasir/anggota/pdf/tahun') !!}/"+ df + "/" + dt + "/" + $('#cabangnya').val() + "/" + $('#jenisnya').val());
            location.href="{{ url('pos/laporan/penjualan')  }}";
        });
    }
    else
    {
        ...
        $('#pdf').on('click', function () {
            ...
            // alert(dfrom);
            window.open("{!! url('pos/laporan/periodik/anggota/pdf/hari') !!}/"+ $('#kasirnya').val() + "/" + df  + "/" + dt + "/" + $('#cabangnya').val() + "/" + $('#jenisnya').val());
            location.href="{{ url('pos/laporan/penjualan')  }}";
        ...
        $('#pdf1').on('click', function () {
            ...
            window.open("{!! url('pos/laporan/periodik/anggota/pdf/bulan') !!}/"+ $('#kasirnya').val() + "/" + df + "/" + dt + "/" + $('#cabangnya').val() + "/" + $('#jenisnya').val());
            location.href="{{ url('pos/laporan/penjualan')  }}";
        });
        $('#pdf2').on('click', function () {
            ...
            window.open("{!! url('pos/laporan/periodik/anggota/pdf/tahun') !!}/"+ $('#kasirnya').val() + "/" + df + "/" + dt + "/" + $('#cabangnya').val() + "/" + $('#jenisnya').val());
            location.href="{{ url('pos/laporan/penjualan')  }}";
        });
    ...
    $('#idkasir').on('change', function()
    {
        ...
        if ($('#idkasir').val()=="allkasir") {
            ...
            $('#btnok1').on('click', function () {
                ...
                location.href = "{!! url('pos/anggota/all/days') !!}/" + dfrom + "/" + dto + "/" + $('#idkasi').val() + "/" + $('#idkasirr').val();
            });
            ...
            $('#btnok2').on('click', function () {
                ...
                location.href = "{!! url('pos/anggota/all/months') !!}/" + df + "/" + dt + "/" + $('#idkasi').val() + "/" + $('#idkasirr').val();
            });
            ...
            $('#btnok3').on('click', function () {
                ...
                location.href = "{!! url('pos/anggota/all/years') !!}/" + df + "/" + dt + "/" + $('#idkasi').val() + "/" + $('#idkasirr').val();
            });
        ...
        else
        {
            ...
            $('#btnok1').on('click', function () {
                ...
                location.href = "{!! url('pos/anggota/days') !!}/" + $('#idkasir').val() + "/" + dfrom + "/" + dto + "/" + $('#idkasi').val() + "/" + $('#idkasirr').val();
            });
            ...
            $('#btnok2').on('click', function () {
                ...
                var df = $('#datepickerr1').val();
                var dt = $('#datepickerr2').val();
                location.href = "{!! url('pos/anggota/months') !!}/" + $('#idkasir').val() + "/" + df + "/" + dt +  "/" + $('#idkasi').val() + "/" + $('#idkasirr').val();
            });
            ...
            $('#btnok3').on('click', function () {
                ...
                var df = $('#datepickerrr1').val();
                var dt = $('#datepickerrr2').val();
                location.href = "{!! url('pos/anggota/years') !!}/" + $('#idkasir').val() + "/" + df + "/" + dt + "/" + $('#idkasi').val() + "/" + $('#idkasirr').val();
            });
