...
<div style="color:black;font-size:16px;position:absolute;margin-left:53%;margin-top:10%">Pilih Bulan</div>
...
<a onclick="FunctionLoading()" href="{!! url('pos/kasir/bulan') !!}"><div style="background:#3498db;position:absolute;width:22.2%;height:8%;margin-left:0px;margin-top:13%;padding-left:5%;color:#FFF;font-size:18px;text-align:left;padding-top:1%;position:absolute;cursor:pointer;">Laporan Bulanan
</div></a>
...
if (kasir=="Semua Kasir") {
          ...
          $('#pdf').on('click', function () {
                  ...
                  window.open("{!! url('pos/kasir/bulan/sum/pdf') !!}/" + df + "/" + $('#cabangnya').val() + "/" + $('#jenisnya').val());
        });
...
else
{
    ...
    $('#pdf').on('click', function () {
                  ...
                  var df = $('#tanggalnya').val();
                  window.open("{!! url('pos/kasir/bln/sum/pdf') !!}/"+ $('#kasirnya').val() + "/" + df + "/" + $('#cabangnya').val() + "/" + $('#jenisnya').val());
        });
...
$('#idkasir').on('change', function()
{
  ...
  if ($('#idkasir').val()=="allkasir")
  {
    ...
    $('#btnok').on('click', function () {
                  ...
                  location.href = "{!! url('pos/kasir/bulan') !!}/" + df + "/" + $('#idkasi').val() + "/" + $('#idkasirr').val();
        });
  ...
  else
  {
    $('#btnok').on('click', function () {
                  ...
                  var df = $('#datepicker').val();
                  location.href = "{!! url('pos/kasir/bln') !!}/"+ $('#idkasir').val() + "/" + df + "/" + $('#idkasi').val() + "/" + $('#idkasirr').val();
        });
