...
<head>
    ...
    <title>Rekap Transaksi Cabang</title>
</head>

<body class="metro" onload="StartClock()" onunload="KillClock()">
<header>
    <div style="margin-top:2%;">
        <p ><b>{!! $koperasi->nama_koperasi !!}</b> <br>{!! $koperasi->alamat_koperasi !!}
            <br> {!! $telepon_koperasi !!}

        </p>
    </div>
    <p style="padding-left:33%; padding-right:33%;"><b>REKAP TRANSAKSI CABANG</b>
        <br>
