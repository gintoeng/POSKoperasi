...
<a onclick="FunctionLoading()" href="{!!url('/pos/anggota')!!}"><div style="cursor:pointer;height:80px; margin-top:50px;float:left; margin-left:10px; position:absolute;color:#3498db;font-size:50px"><img src="{{ url('assets/poscss/imgs/back.png') }}" style="width:40px;height:40px" alt="">&nbsp;<b>Detail Penjualan Anggota</b></div></a>


<div style="width:100%; height:100%; margin: 0 auto; background-color:#FFF">


    <div id="show" style="color:black;font-size:22px;position:absolute;margin-left:4%;margin-top:14%">NPK &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</div>
    <div id="show" style="color:black;font-size:22px;position:absolute;margin-left:29%;margin-top:14%">Kode&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</div>
    <div id="show" style="color:black;font-size:22px;position:absolute;margin-left:4%;margin-top:18%">Nama&nbsp;&nbsp;&nbsp;&nbsp;:</div>
    ...
    <div id="hide" style="color:black;font-size:22px;position:absolute;margin-left:29%;margin-top:18%">No. Reff&nbsp;:</div>
    ...
    <div style="font-size:22px;position:absolute;margin-left:37%;width:90%;margin-top:14%;color:#000">
        {{ $anggota->kode  }}
    </div>
    ...
    <div style="font-size:22px;position:absolute;margin-left:37%;width:22.5%;margin-top:18%;color:#000">
        {{ $noreff  }}
    </div>
