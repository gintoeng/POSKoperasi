...
<label style="width:100%;margin-left:0%;margin-top:0pt;font-size:12pt;position:absolute;text-align: center;"><b>{!! $nama_koperasi !!}</b></label>
...
<div style="background:;height:5%;width:100%;margin-top:37%;margin-left:5%;position:absolute;font-size:8pt">Jenis Pembayaran&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: Cash</div>
   ...
   <div class="col-md-6 col-sm-6 col-xs-12" style="margin-top:45%; margin-left:0%; width:100%;height:5%;">
                           ...
                           <!-- </div>-->
<div style="position:absolute;margin-top:11%;margin-left:-18%">------------------------------------------------------------------------------</div>
<div style="position:absolute;margin-top:40%;margin-left:-18%">------------------------------------------------------------------------------</div>
...
<div style="margin-top:29%;margin-left:0%;position:absolute;font-size:8pt">Bayar &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</div>
<div style="margin-top:20%;margin-left:-2.2%;position:absolute;font-size:8pt">Total Bersih :</div>
<div style="margin-top:37%;margin-left:0%;position:absolute;font-size:8pt">Kembalian :</div>
...
<div style="margin-top:29%;margin-left:25%;position:absolute;font-size:8pt">Rp. {!! number_format($bayaran ,2,",",".") !!}</div>
<div style="margin-top:20%;margin-left:25%;position:absolute;font-size:8pt">Rp. {!! number_format($total_bersih ,2,",",".") !!}</div>
<div style="margin-top:37%;margin-left:25%;position:absolute;font-size:8pt">Rp. {!! number_format($kembalian ,2,",",".") !!}</div>
</div>
