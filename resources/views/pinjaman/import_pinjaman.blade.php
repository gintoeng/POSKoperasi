...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{!! url('pinjaman') !!}">Daftar Pinjaman</a></li>
        ...
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="post" enctype="multipart/form-data" action="{!! url('pinjaman/import') !!}" id="fimppinj">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type='text' readonly class='form-control' value='Sheet 1 : NO_PINJAMAN | NO_ANGGOTA | JENIS_PINJAMAN | SUKU_BUNGA | WAKTU_PINJAMAN | SISTEM_BUNGA | '><br/>
                                        <input type='text' readonly class='form-control' value='TGL_PENGAJUAN | TGL_REALISASI | JML_PENGAJUAN | JML_REALISASI | ANGSURAN | REALISASI | LUNAS | '><br/>
                                        <input type='text' readonly class='form-control' value='TGL_BAYAR_AKHIR | SALDO_AKHIR | DIGUNAKAN_UNTUK | SUMBER_DANA | KETERANGAN'>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <ul>
                                            <li>NO_ANGGOTA : id dari Master CUSTOMER</li>
                                            <li>JENIS_PINJAMAN : id dari Pengaturan Pinjaman</li>
                                            <li>SUKU_BUNGA : % per Tahun</li>
                                            <li>WAKTU_PINJAMAN : jangka waktu pinjaman</li>
                                            <li>SISTEM_BUNGA : Bulanan / Harian ( Pilih salah satu )</li>
                                            <li>TGL_BAYAR_AKHIR : tanggal pembayaran terakhir</li>
                                            <li>SALDO_AKHIR : sisa saldo pinjaman</li>
                                            <li>TGL_PEMBUATAN : YYYY-MM-DD</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <a href="{!! url('pinjaman/import/sample') !!}" class="btn btn-warning btn-block"><i class="ti-download mr5"></i>Sample</a>
                                    </div>
                                    <div class="col-sm-2">
