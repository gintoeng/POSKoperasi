...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Autodebet Pinjaman</li>
    </ol>
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <form method="post" action="{!! url('akuntansi/autodebet/pinjaman') !!}" id="fautopinj" enctype="multipart/form-data">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="alert alert-info">
                                    <br>
                                    <p>AUTODEBET berfungsi untuk membayar : </p>
                                    <br>
                                    <p>Angsuran pinjaman beserta bunga dan dendanya</p>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive no-border" id="table-scroll">
                                <table id="tabauto" class="table table-bordered table-striped no-m scroll" style="height:800px; display: -moz-groupbox;">
                                    <thead>
                                    ...
                                    @foreach($auto as $tampil)
                                        <tr style="width: 100%;display: inline-table;table-layout: fixed;">
                                            ...
                                            <td>{!! $tampil->pinjamanid->nomor_pinjaman !!}</td>
                                            <td>{!! $tampil->pinjamanid->anggotaid->nama !!}</td>
    ...
    <script>
        $('#btnlihat').on('click', function() {
            ...
            $('#tabauto').load("{!! url('akuntansi/autodebet/pinjaman/show') !!}/" + $('#bulan').val() + "/" + $('#tahun').val()  + "/" + $('#shu').val());
            $("#rejectModal").modal();
        });

        function cetak(cce) {
            window.open("{!! url('akuntansi/autodebet/pinjaman/cetak') !!}/" + $('#bulan').val() + "/" + $('#tahun').val());
        }
        ...
        $('#btnsub').on('click', function() {
            $.ajax({
                url: "{!! url('akuntansi/autodebet/pinjaman/cek') !!}",
                data: {},
                dataType: "json",
                type: "get",
                success:function(data)
        ...
        $('#btndown').on('click', function () {
            ...
            if ($('#shu').val() == "") {
                ...
                location.href = "{!! url('akuntansi/autodebet/pinjaman/download') !!}/" + b + "/" + t  + "/" + shu + "/" + df + "/" + dt;
            }
        });
    </script>
