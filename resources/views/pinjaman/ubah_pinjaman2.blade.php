        ...
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="post" action="{!! url('pinjaman/'.$pinjaman->id.'/update') !!}" enctype="multipart/form-data" id="fpinj">
                        ...
                        <div class="box-tab">
                            <ul class="nav nav-tabs">
                                <li><a href="#umum" data-toggle="tab">Data Pinjaman</a>
                                </li>
                                <li><a href="#penjamin" data-toggle="tab">Data Keluarga & Penjamin</a>
                                </li>
                                <li class="active"><a href="#jaminan" data-toggle="tab">Data Agunan / Jaminan</a>
                                </li>
                            </ul>
                    ...
                    <div class="tab-pane fade active in" id="jaminan">
                        <div class="row">
                            <div class="col-md-12">
