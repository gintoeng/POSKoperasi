...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="nomor_pinjaman" placeholder="Jenis Pinjaman" value="{!! $pembayaran->pinjamanid->nomor_pinjaman !!} - {!! $pembayaran->pinjamanid->anggotaid->nama !!}" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="jenis_pinjaman" placeholder="Jenis Pinjaman" value="{!! $pembayaran->pinjamanid->pengaturanid->nama_pinjaman !!}" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="alamat_anggota" placeholder="Alamat Anggota" value="{!! $pembayaran->pinjamanid->anggotaid->alamat !!}, {!! $pembayaran->pinjamanid->anggotaid->kota !!}, {!! $pembayaran->pinjamanid->anggotaid->provinsi !!}" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="spinner input-group" id="suku_bunga">
                                            <input name="suku_bunga" type="text" class="form-control input-sm spinner-input" id="suku-bunga" placeholder="Suku Bunga" value="{!! $pembayaran->pinjamanid->pengaturanid->suku_bunga !!}" readonly>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input name="tanggal_realisasi" type="text" class="form-control datepicker" id="tanggal_realisasi" value="{!! $tgl_real !!}" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="tanggal_jt_pinjaman" class="col-sm-6 control-label">Tanggal Jatuh Pinjaman</label>
                                    <div class="col-sm-6">
                                        <input name="tanggal_jt_pinjaman" type="text" class="form-control datepicker" id="tanggal_jt_pinjaman" value="{!! $tgl_tempo !!}" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="tangaal_jt_periode" class="col-sm-6 control-label">Tanggal JT Periode</label>
                                    <div class="col-sm-6">
                                        <input name="tanggal_jt_periode" type="text" class="form-control datepicker" id="tanggal_jt_periode" value="{!! $tgl_periode !!}" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="tangaal_transaksi" class="col-sm-6 control-label">Tanggal Transaksi</label>
                                    <div class="col-sm-6">
                                        <input name="tanggal_transaksi" type="text" class="form-control datepicker" id="tanggal_transaksi" value="{!! $tgl_bayar !!}" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="spinner input-group" id="suku_bunga">
                                            <input name="jumlah_hari" type="text" class="form-control input-sm spinner-input" id="jumlah_hari" placeholder="Jumlah Hari" value="{!! $pembayaran->bulan_ke !!}" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="spinner input-group" id="suku_bunga">
                                            <input name="jumlah_hari_terlambat" type="text" class="form-control input-sm spinner-input" id="jumlah_hari_terlambat" placeholder="Jml Hari Terlambat" value="{!! $hari !!}" readonly>
                                            {{--<div class="spinner-buttons input-group-btn">--}}
                                            {{--<button type="button" class="btn btn-warning btn-sm spinner-down">--}}
                                            {{--<i class="ti-minus"></i>--}}
                                            {{--</button>--}}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label><input name="cara_bayar" type="radio" value="Tunai" {{ $pembayaran->cara_bayar == "TUNAI" ? 'checked' : '' }} id="tun"> Tunai</label>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <label><input name="cara_bayar" type="radio" value="Simpanan" {{ $pembayaran->cara_bayar == "SIMPANAN" ? 'checked' : '' }} id="simp"> Dari Simpanan</label>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <label><input name="cara_bayar" type="radio" value="Autodebet" {{ $pembayaran->cara_bayar == "AUTODEBET" ? 'checked' : '' }} id="autod"> Autodebet</label>
                                        </div>
                                    </div>
                                </div>
                                {{--<div class="form-group">--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="keterangan" class="form-control" id="keterangan" placeholder="Keterangan" value="{!! $pembayaran->keterangan !!}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <input type="hidden" id="simbid" value="{!! $pembayaran->pinjamanid->pengaturanid->sistem_bunga !!}">
    <input type="hidden" id="simb" value="{!! $pembayaran->pinjamanid->pengaturanid->sbunga->sistem !!}">
