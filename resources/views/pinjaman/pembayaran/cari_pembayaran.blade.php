                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form-inline" role="form" method="get" action="{{ url('pinjaman/pembayaran/search') }}" id="fsearch">
                                <div class="form-group mr5">
                                    ...
                                    <input name="query" type="text" value="{{$query}}" class="form-control" placeholder="Cari pembayaran" id="cari">
                                </div>
                                <input type="hidden" name="search" value="1">
                                <button type="submit" class="btn btn-sm btn-primary"><i class="ti ti-search"> Cari</i></button>
                                <a href="{!! url('pinjaman/pembayaran') !!}"><button type="button" class="btn btn-color btn-sm"><i class="ti ti-reload"> Reset</i></button></a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-right">
                                        {!! $pembayaran->appends(['query' => $query])->links() !!}
                                    </div>
                                </div>
                            </div>
                        </div>
