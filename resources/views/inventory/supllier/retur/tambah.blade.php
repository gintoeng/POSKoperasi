...
<html>
    ...
    <body id="">
        ...
        <h1 style="margin-left:4%; margin-top:3%;"><a href="{!! url('inventory/supplier/retur') !!}" class="nav-button transform"><span></span></a>&nbsp;Tambah Data Retur</h1>
        <hr style="width:95%;"><br>
        <div class="grid">
            <form action="{{url('inventory/supplier/retur/storeheader')}}" method="POST">
    ...
    <script>
        ...
        $("#search").keyup(function (e) {
            if (e.keyCode == 13) {
                $("#divpertama").load("{{ URL::to('inventory/supplier/retur/get2')}}/"+$("#search").val() +"/"+ $("#pilihan").val());
