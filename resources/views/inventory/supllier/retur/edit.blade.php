...
<h1 style="margin-left:4%; margin-top:3%;"><a href="{!! url('inventory/supplier/retur') !!}" class="nav-button transform"><span></span></a>&nbsp;Edit Data Retur</h1>
...
{{--<div class="grid">--}}
    {{--<div class="row cells12">--}}
        {{--<div class="cell colspan11">--}}
            ...
            {{--<a class="place-right button bg-emerald bg-active-emerald fg-white" target="_blank" href="{!! url('inventory/supplier/retur/cetak/'.$header->id) !!}"><span class="mif-file-archive mif-ani-float"></span>Cetak Retur</a>--}}
        {{--</div>--}}
        {{--<div class="cell"></div>--}}
    {{--</div>--}}
{{--</div>--}}
        ...
        <div class="cell colspan10">
            ...
            <div class="row cells2">
                ...
                <div class="cell">
                    ...
                    <div class="input-control text full-size">
                        <input type="text" name="status" readonly value="{{$header->jenis_retur == "barang" ? 'Barang' : 'Uang'}}">
                    </div>
                </div>
            </div>
            <div class="row cells2">
            ...
            <div class="grid">
                <div class="row cells12">
                    <div class="cell colspan6">
                        ...
                        <a href="{{url('inventory/supplier/retur/prosesretur/'.$header->id)}}" ><button type="submit" class="button bg-cobalt bg-active-darkBlue fg-white"><span class="mif-tag mif-ani-float"></span> Retur</button></a>
                    </div>
                    <div class="cell colspan6">
            ...
            <table class="dataTable striped hovered cell-hovered border bordered " data-searching="true" style="overflow:auto; width:100%; background-color:#fff; width:100%;">
                ...
                @foreach($header->detail as $details)
                    <tr>
                        ...
                        <td><center>
                                <a href="{{url('inventory/supplier/retur/hapusdetail/'.$details->id.'/'.$header->id)}}"class="button danger" align="center">Hapus</a>
...
<script>
    ...
    $("#search").keyup(function (e) {
        if (e.keyCode == 13) {
            $("#divpertama").load("{{ URL::to('inventory/supplier/retur/get')}}/"+$("#search").val() +"/"+ $("#pilihan").val() + "/" + header);
