...
<h1 style="margin-left:4%; margin-top:3%;"><a href="{!! url('inventory/supplier/penerimaan') !!}" class="nav-button transform"><span></span></a>&nbsp;Edit Data Penerimaan</h1>
...
<div class="grid">
    ...
    <div class="row cells12">
        <div class="cell"></div>
        <div class="cell colspan10">
            <form action="{{url('inventory/supplier/penerimaan/updatedetail/'.$header->id)}}" method="post" enctype="multipart/form-data">
                <div class="grid">
                    <div class="row cells12">
                        <div class="cell colspan6">
                            <button type="submit" class="button success"><span class="mif-paper-plane mif-ani-float"></span> Simpan</button>
                ...
                <table class="dataTable striped hovered cell-hovered border bordered " data-searching="true" style="overflow:auto; width:100%; background-color:#fff; width:100%;">
                    ...
                    <tr>
                        ...
                        <th class="text-center ribbed-cyan fg-white padding10 text-shadow">Expired</th>
                    ...
                    @foreach($detail as $details)
                        <tr>
                            ...
                            <td align="center">
                                <div class="input-control text full-size" id="datepicker{{$details->id}}">
                                    <input type="text" name="tanggal{{$details->id}}" value="">
...
<script>
    $(function(){
        @foreach($detail as $details)
            $("#datepicker{{$details->id}}").datepicker();
        @endforeach
    });
