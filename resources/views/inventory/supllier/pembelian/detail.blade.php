...
<h1 style="margin-left:4%; margin-top:3%;"><a href="{!! url('inventory/supplier/pembelian') !!}" class="nav-button transform"><span></span></a>&nbsp;Detail Pembelian</h1>
<hr style="width:95%;"><br>
<div class="grid">
    <div class="row cells12">
        <div class="cell colspan11">
            {{--<a class="place-right button bg-darkViolet bg-active-darkViolet fg-white" target="_blank" href="{!! url('inventory/supplier/pembelian/porder/'.$header->id) !!}"><span class="mif-file-archive mif-ani-float"></span>Invoice</a>--}}
            <a class="place-right button bg-emerald bg-active-emerald fg-white" target="_blank" href="{!! url('inventory/supplier/pembelian/porder/'.$header->id) !!}"><span class="mif-file-archive mif-ani-float"></span>Cetak Pembelian</a>
        </div>
        <div class="cell"></div>
    </div>
</div>
                ...
                <div class="grid">
                    <div class="row cells12">
                        ...
                        <div class="cell colspan5">
                            <div class="input-control text" data-role="input" style="width:100%;">
                                <input type="text" name="search" id="search">
                                <button id="searchbtn" ctype="button" lass="button info"><span class="mif-search"></span></button>
                            </div>
                        </div>
                    </div>
                </div>
