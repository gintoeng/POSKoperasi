...
<body class="metro" style="width:100%;">
      ...
      <div data-role="dialog" id="dialog" class="padding20" data-close-button="true" data-overlay="true" data-overlay-color="op-dark" data-overlay-click-close="true" data-windows-style="true" data-background="bg-blue" data-color="fg-white">
            <h1><span class="mif-qrcode"></span>&nbsp;Stock Opname</h1>
            <hr style="background-color:#fff;">
            <br>
            <div class="place-right">

                  <p style="margin-right:10%;"> Total Data yang telah dihitung :   </p>

                  <div class="input-control text warning" data-role="input" style="width:100%;">
                    <input type="number" required type="numeric" >
                    <button class="button warning"><span class="mif-play"></span>&nbsp;Mulai</button>
                  </div>
            </div>
