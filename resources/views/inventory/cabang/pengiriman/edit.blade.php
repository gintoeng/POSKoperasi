...
<h1 style="margin-left:4%; margin-top:3%;"><a href="{!! url('inventory/cabang/pengiriman') !!}" class="nav-button transform"><span></span></a>&nbsp;Edit Data Pengiriman</h1>
    ...
    <div class="container" style="height:500px;">
        <div class="row cells12">
            ...
            <div class="cell colspan10">
                ...
                <div id="divpertama1">
                    <form action="{{url('inventory/cabang/pengiriman/storebarang')}}" method="POST">
