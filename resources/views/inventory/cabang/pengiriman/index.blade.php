...
<html>
    ...
    <body id="">
        ...
        <h1 style="margin-left:4%; margin-top:3%;"><a href="{!! url('/inventory') !!}" class="nav-button transform"><span></span></a>&nbsp;Pengiriman Cabang</h1>
                ...
                <table class="dataTable striped hovered cell-hovered border bordered " data-searching="true" style="overflow:auto; width:100%; background-color:#fff; width:100%;">
                    ...
                    <?php $i = ($header->currentPage() - 1) * $header->perPage() + 1; ?>
                        ...
                        <tr>
                            ...
                            <td colspan="3"><center>
                                    <a href="{{url('inventory/cabang/pengiriman/editheader/'.$headers->id)}}"><button type="button" class="button {{$headers->receive == "1" ? 'bg-grayLight fg-white' : 'warning'}}" align="center" {{$headers->receive == "1" ? 'disabled' : ''}}>Edit</button></a>
