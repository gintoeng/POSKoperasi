...
<h1 style="margin-left:4%; margin-top:3%;"><a href="{!! url('/inventory') !!}" class="nav-button transform"><span></span></a>&nbsp;Tambah Data Pengiriman</h1>
<hr style="width:95%;"><br>
<div class="grid">
    <form action="{{url('inventory/cabang/pengiriman/storeheader')}}" method="POST">
...
<script>
    ...
    $("#search").keyup(function (e) {
        if (e.keyCode == 13) {
            $("#divpertama").load("{{ URL::to('inventory/cabang/pengiriman/get2')}}/"+$("#search").val() +"/"+ $("#pilihan").val());
