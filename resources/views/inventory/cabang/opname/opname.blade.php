...
<h1 style="margin-left:4%; margin-top:3%;"><a href="{!! url('inventory/cabang/opname') !!}" class="nav-button transform"><span></span></a>&nbsp;Opname</h1>
                ...
                <table class="dataTable striped hovered cell-hovered border bordered " data-searching="true" style="overflow:auto; width:100%; background-color:#fff; width:100%;">
                    ...
                    @foreach($header->detail as $details)
                        <tr>
                            ...
                            <td><center>
                                    <a href="javascript:void(0)" onclick="historyop({{$details->barang->id}})"><button type="button" class="button primary" align="center">History</button> </a>
...
<div data-role="dialog" id="dialog4" class="padding20" data-close-button="true" data-windows-style="true" data-overlay="true" data-overlay-color="op-dark" data-overlay-click-close="true">
    <div class="container" style="height:500px;">
        <div class="row cells12">
            <div class="cell"></div>
            <div class="cell colspan10">
                <div class="grid">
                    <h3>History Opname</h3>
                </div>
                <hr>
                <div id="divpertama4"> </div>
                <div id="divpertama44">
                        <div class="container" id="" style="overflow-y: scroll; height:400px;">
                            <table class="dataTable bordered" data-searching="true" style="overflow:auto; width:100%; background-color:#fff;">
                                <thead>
...
<script>
    ...
    function sdialog4() {
        var dialog4 = $('#dialog4').data('dialog');
        dialog4.open();
    }

    function historyop(id) {
        $("#divpertama4").load("{{ url('inventory/cabang/opname/history')}}/"+id);
        document.getElementById('divpertama44').style.display = 'none';
        sdialog4();
    }
