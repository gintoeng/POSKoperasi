        ...
        <div class="cell colspan10">
            <form action="{{url('inventory/cabang/opname/search')}}" method="get">
                <div class="row cells12">
                    ...
                    <div class="cell colspan4">
                        ...
                        <a href="{{url('inventory/cabang/opname')}}"><button type="button" class="button warning"><span class="mif-history"></span></button></a>
                        {{csrf_field()}}
                    </div>
                    <div class="cell colspan4">
            ...
            <table class="dataTable striped hovered cell-hovered border bordered " data-searching="true" style="overflow:auto; width:100%; background-color:#fff; width:100%;">
                ...
                @foreach($header as $headers)
                    @if($headers->id_cabang == \Illuminate\Support\Facades\Auth::user()->cabang && $headers->tipe == "opname")
                        <tr>
                            <td>{{$i++}}</td>
                            ...
                            <td colspan="3"><center>
                                    ...
                                    <a href="{{url('inventory/cabang/opname/detail/'.$headers->id)}}" class="button info" align="center">Detail</a></center></td>
                        </tr>
                    @endif
                @endforeach
                </tbody>
