...
<h1 style="margin-left:4%; margin-top:3%;"><a href="{!! url('inventory/cabang/opname') !!}" class="nav-button transform"><span></span></a>&nbsp;Detail Opname</h1>
...
<div class="grid">
    <div class="row cells12">
        <div class="cell colspan11">
            ...
            <a class="place-right button bg-emerald bg-active-emerald fg-white" target="_blank" href="{!! url('inventory/cabang/opname/cetak/'.$header->id) !!}"><span class="mif-file-archive mif-ani-float"></span>Cetak Opname</a>
        </div>
        <div class="cell"></div>
    </div>
</div>
            ...
            <table class="dataTable striped hovered cell-hovered border bordered " data-searching="true" style="overflow:auto; width:100%; background-color:#fff; width:100%;">
                ...
                @foreach($detail as $details)
                    <tr>
                        ...
                        <td align="center">{{$details->stok_fisik}}</td>
