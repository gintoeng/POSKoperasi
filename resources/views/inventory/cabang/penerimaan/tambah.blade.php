...
<h1 style="margin-left:4%; margin-top:3%;"><a href="{!! url('inventory/cabang/penerimaan') !!}" class="nav-button transform"><span></span></a>&nbsp;Tambah Data Penerimaan</h1>
...
<div class="grid">
    <div class="row cells12">
        ...
        <div class="cell colspan10">
            <form action="{{url('inventory/cabang/penerimaan/storeheader')}}" method="POST" enctype="multipart/form-data">
