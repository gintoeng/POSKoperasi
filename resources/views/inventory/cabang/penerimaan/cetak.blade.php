...
<header>
    <table style="margin-top: 5%; position: absolute">
        <tr>
            <td>Dari Cabang</td>
            <td width="1">:</td>
            <td width="100">{{$cbtujuan->nama}}</td>
        </tr>
        <tr>
            <td>Alamat</td>
            <td width="1">:</td>
            <td width="50">{{$cbtujuan->alamat}}, {{$cbtujuan->kota}}, {{$cbtujuan->provinsi}}, {{$cbtujuan->kode_pos}}</td>
        </tr>
        <tr>
            <td>Telepon</td>
            <td width="1">:</td>
            <td width="100">{{$cbtujuan->telepon}}</td>
        </tr>
    </table>
    <p style="margin-left: 60%;  position: absolute">
        <label style="font-size: 20px"><b>Document Penerimaan Cabang</b></label>
    </p>
