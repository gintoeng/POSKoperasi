...
<html>
    ...
    <body id="">
        ...
        <h1 style="margin-left:4%; margin-top:3%;"><a href="{!! url('inventory/cabang/penerimaan') !!}" class="nav-button transform"><span></span></a>&nbsp;Detail Data Penerimaan</h1>
        ...
        <div class="grid">
            <div class="row cells12">
                <div class="cell colspan11">
                    ...
                    <a class="place-right button bg-emerald bg-active-emerald fg-white" target="_blank" href="{!! url('inventory/cabang/penerimaan/cetak/'.$header->id) !!}"><span class="mif-file-archive mif-ani-float"></span>Cetak Penerimaan</a>
                </div>
                <div class="cell"></div>
            </div>
        </div>
                ...
                <div class="cell colspan10">
                    ...
                    <div class="row cells2">
                        <div class="cell">
                            ...
                            <div class="input-control text full-size">
                                <?php $cabangnya = \App\Model\Inventory\pembelianSupplierHeader::find($header->id_terima);?>
                                <input type="text" name="cabang" readonly value="{{$cabangnya->cabang->nama}}">
                            </div>
                        </div>
                        {{--<div class="cell">--}}
                            {{--<label>Vendor</label>--}}
            ...
            <div class="container" style="height:500px;">
                <div class="row cells12">
                    ...
                    <div class="cell colspan10">
                        ...
                        <div id="divpertama1">
                            <form action="{{url('inventory/supplier/penerimaan/storebarang')}}" method="POST">
    ...
    <script>
        ...
        $("#search").keyup(function (e) {
            if (e.keyCode == 13) {
                $("#divpertama").load("{{ URL::to('inventory/cabang/penerimaan/get')}}/"+$("#search").val() +"/"+ $("#pilihan").val() + "/" + header);
