...
<h1 style="margin-left:4%; margin-top:5%;"><a href="{!! url('/inventory') !!}" class="nav-button transform"><span></span></a>&nbsp;Stok Minimum</h1>
...
<div class="cell">
    <div class="cell colspan10" style="padding-left:5%; padding-right:5%;">
        ...
        <hr>
        <form action="{{ url('stok/minimum/pdf/cetak')  }}" target="_blank" method="get">
