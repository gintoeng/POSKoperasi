        ...
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="post" enctype="multipart/form-data" action="{!! url('simpanan/import') !!}" id="fimpsimp">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type='text' readonly class='form-control' value='Sheet 1 : NO_SIMPANAN | KD_ANGGOTA | KD_PENGATURAN | SUKU_BUNGA | '><br/>
                                        <input type='text' readonly class='form-control' value='TGL_PEMBUATAN | SALDO_AKHIR | KETERANGAN'>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <ul>
                                            <li>KD_ANGGOTA : kode dari Master Customer</li>
                                            <li>KD_PENGATURAN : kode dari Pengaturan Simpanan</li>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <a href="{!! url('simpanan/import/sample') !!}" class="btn btn-warning btn-block"><i class="ti-download mr5"></i>Sample</a>
                                    </div>
                                    <div class="col-sm-2">
