...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{!! url('simpanan/transaksi') !!}">Daftar Transaksi</a></li>
    </ol>
    <div class="row">
        <div class="col-md-12">
            <section class="panel">
                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form-inline" role="form" method="get" action="{{ url('simpanan/transaksi/search') }}">
                                <div class="form-group mr5">
                                    ...
                                    <input name="query" type="text" class="form-control" placeholder="Cari transaksi" value="{{ $query }}" id="cari">
                                </div>
                                <input type="hidden" name="search" value="1">
                                <button type="submit" class="btn btn-sm btn-primary"><i class="ti ti-search"> Cari</i></button>
                                <a href="{!! url('simpanan/transaksi') !!}"><button type="button" class="btn btn-color btn-sm"><i class="ti ti-reload"> Reset</i></button></a>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-right">
{{--                                        {!! str_replace('?','?query='.$query.'&',$transaksi->links()) !!}--}}
                                        {!! $transaksi->appends(['query' => $query])->links() !!}
                                    </div>
                                </div>
                            </div>
                        </div>
