...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Tambah Module</li>
    </ol>
    <section class="panel">
        <div class="panel-body">
            <form class="form-horizontal" role="form" method="post" action="{{ url('pengaturan/module/add') }}">
                {!! csrf_field() !!}
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input name="module_name" type="text" class="form-control" id="module_name" placeholder="Class">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="module_name" class="col-sm-3 control-label">Menu Mask</label>
                            <div class="col-sm-9">
                                <input name="menu_mask" type="text" class="form-control" id="menu_mask" placeholder="Menu">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="module_name" class="col-sm-3 control-label">Menu Path</label>
                            <div class="col-sm-9">
                                <input name="menu_path" type="text" class="form-control" id="menu_path" placeholder="Path">
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <select name="menu_icon" id="menu-icon" class="form-control" data-placeholder="Pilih Icon" style="width: 100%">
                                    ...
                                    <optgroup label="Arrows & Direction Icons">
                                        @foreach($icon as $item)
                                            <option value="{!! $item->icon_name !!}" class="{!! $item->icon_name !!}">{!! $item->icon_name !!}</option>
                                        @endforeach
                                    </optgroup>
                                    <optgroup label="Web App Icons">
                                        @foreach($icon2 as $item2)
                                            <option value="{!! $item2->icon_name !!}" class="{!! $item2->icon_name !!}">{!! $item2->icon_name !!}</option>
                                        @endforeach
                                    </optgroup>
                                    <optgroup label="Control Icons">
                                        @foreach($icon3 as $item3)
                                            <option value="{!! $item3->icon_name !!}" class="{!! $item3->icon_name !!}">{!! $item3->icon_name !!}</option>
                                        @endforeach
                                    </optgroup>
                                    <optgroup label="Text Editor Icons">
                                        @foreach($icon4 as $item4)
                                            <option value="{!! $item4->icon_name !!}" class="{!! $item4->icon_name !!}">{!! $item4->icon_name !!}</option>
                                        @endforeach
                                    </optgroup>
                                    <optgroup label="Layout Icons">
                                        @foreach($icon5 as $item5)
                                            <option value="{!! $item5->icon_name !!}" class="{!! $item5->icon_name !!}">{!! $item5->icon_name !!}</option>
                                        @endforeach
                                    </optgroup>
                                    <optgroup label="Brand Icons">
                                        @foreach($icon6 as $item6)
                                            <option value="{!! $item6->icon_name !!}" class="{!! $item6->icon_name !!}">{!! $item6->icon_name !!}</option>
                                        @endforeach
                                    </optgroup>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="spinner input-group">
                                    <input name="menu_order" type="text" class="form-control input-sm spinner-input" id="menu_order" value="0" placeholder="Order">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="divider_after" class="checkbox" id="divider_after" value="1">
                            </div>
                        </div>
                        <div class="form-group">
