...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{url}/laporan/lain/jurnal">Daftar Jurnal</a></li>
    </ol>
    <div class="row">
        ...
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="post" action="{!! url('laporan/lain/daftar/jurnal/cetak') !!}">
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <div class="box-tab">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#umum" data-toggle="tab">Laporan Daftar Jurnal</a>
                                </li>
                            </ul>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="jenis_transaksi" class="form-control" id="jenis_trannsaksi">
                                                        <option value=""></option>
                                                        <option value="sendiri">Input Sendiri</option>
