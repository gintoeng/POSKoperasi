...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{url}/laporan/lain/jurnal">Tabungan Transaksi</a></li>
    </ol>
    <div class="row">
        ...
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="post" action="{!! url('laporan/lain/tabungantrans/cetak') !!}">
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <div class="box-tab">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#umum" data-toggle="tab">Laporan Tabungan Transaksi</a>
                                </li>
                            </ul>
