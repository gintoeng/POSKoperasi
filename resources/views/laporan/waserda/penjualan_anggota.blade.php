        ...
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="get" action="{!! url('laporan/waserda/penjualan/anggota/cetak') !!}" target="_blank" id="flapst">
                                ...
                                <div class="form-group icheck">
                                    ...
                                    <div class="col-sm-5">
                                        <select name="urut" class="form-control" id="urut" style="width: 100%">
                                            ...
                                            <option value="tipe_pembayaran">Tipe Pembayaran</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 icheck">
                                                ...
                                                <div class="mb5">
                                                    <input tabindex="2" type="radio" id="radio3" name="pilih" value="retrancs">
                                                    <label for="radio2"><i class="fa fa-file-text-o mr5"></i>Rekap Transaksi Berdasarkan Customer</label>
                                                </div>
                                                <div class="mb5">
                                                    <input tabindex="3" type="radio" id="radio3" name="pilih" value="detrancs">
                                                    <label for="radio3"><i class="fa fa-file-text-o mr5"></i>Detail Transaksi Berdasarkan Customer</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
