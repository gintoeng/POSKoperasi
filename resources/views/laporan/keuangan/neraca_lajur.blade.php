...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{url}/laporan/keuangan/neracalajur">Neraca Lajur</a></li>
    </ol>
    <div class="row">
                    ...
                    <form role="form" class="form-horizontal" method="post">
                        ...
                        <div class="box-tab">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#umum" data-toggle="tab">Laporan Neraca Lajur</a>
                                </li>
                                ...
                                <div class="tab-pane fade active in" id="umum">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <br>
                                            <div class="form-group">
                                                <label for="bagi" class="col-sm-3 control-label">Angka Dibagi</label>
                                                <div class="col-sm-9">
                                                    <select name="bagi" class="form-control" id="urut">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 icheck">
                                                    <div class="mb5 mt5">
                                                        ...
                                                        <label for="radio1"><i class="fa fa-file-text-o mr5"></i>Laporan Neraca Lajur</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <a href="{url}/laporan/keuangan/neracalajur/preview" target="_blank" class="btn btn-sm btn-warning mb15"><i class="fa fa-file-text-o mr5"></i>Preview</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <a href="{url}/laporan/keuangan/neracalajur/cetak" target="_blank" class="btn btn-sm btn-info mb15"><i class="ti-printer mr5"></i>Cetak</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-10">
                            <div class="pull-right">
                                <div class="col-sm-2">
                                    <a href="{url}/laporan/keuangan/neracalajur" class="btn btn-danger">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </form>
