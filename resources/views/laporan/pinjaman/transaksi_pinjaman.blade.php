...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{!! url('laporan/pinjaman/transaksi') !!}">Transaksi Pinjaman</a></li>
    </ol>
    <div class="row">
        ...
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="get" action="{!! url('laporan/pinjaman/transaksi/cetak') !!}" target="_blank" id="flappinjtran">
                                ...
                                <div class="form-group icheck">
                                    ...
                                    <div class="col-sm-5">
                                        <select name="urut" class="form-control" id="urut" style="width: 100%">
                                            ...
                                            <option value="tanggal_bayar">Tanggal Transaksi</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 icheck">
                                                <div class="mb5 mt5">
                                                    <input tabindex="1" type="radio" id="radio1" name="pilih" value="tranpinj" checked>
                                                    <label for="radio1"><i class="fa fa-file-text-o mr5"></i>Daftar Transaksi Pinjaman Detail</label>
                                                </div>
                                                <div class="mb5">
                                                    <input tabindex="2" type="radio" id="radio2" name="pilih" value="tranpinjre">
                                                    <label for="radio2"><i class="fa fa-file-text-o mr5"></i>Daftar Transaksi Pinjaman Rekap Harian</label>
                                                </div>
                                                <div class="mb5">
                                                    <input tabindex="4" type="radio" id="radio4" name="pilih" value="tranpinjsaldo">
                                                    <label for="radio4"><i class="fa fa-file-text-o mr5"></i>Daftar Transaksi Pinjaman dan Sisa Saldo</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <a href="{!! url('laporan/pinjaman/transaksi') !!}"><button type="button" class="btn btn-color btn-sm"><i class="ti ti-reload"> Reset</i></button></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-9">
