...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{!! url('laporan/pinjaman/data') !!}">Daftar Pinjaman</a></li>
    </ol>
    <div class="row">
        ...
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="get" action="{!! url('laporan/pinjaman/data/cetak') !!}" target="_blank" id="flappinj">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="tgl" class="col-sm-3 control-label">Tanggal Pengajuan</label>
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="realisasi" class="form-control" id="realisasi" style="width: 100%">
                                            <option value=""></option>
                                            <option value="N">Belum Realisasi</option>
                                ...
                                <div class="form-group icheck">
                                    ...
                                    <div class="col-sm-5">
                                        <select name="urut" class="form-control" id="urut" style="width: 100%">
                                            <option value="nomor_pinjaman">No Kredit</option>
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <a href="{!! url('laporan/pinjaman/data') !!}"><button type="button" class="btn btn-color btn-sm"><i class="ti ti-reload"> Reset</i></button></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-9">
