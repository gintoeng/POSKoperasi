...
<table width="100%">
    ...
    <tbody>
    <?php $i = 1; $s = 0; $t = 0; $x = 0; $y = 0;?>
        @if($sld['s'] != 0)
            <tr>
                <td style="background: #eaeaea" colspan="6" align="left">Tipe: SETOR   Setoran</td>
            </tr>
            ...
            <tr><td colspan="6" align="right">{!! number_format($s,2 ,'.', ',') !!}</td></tr>
        @endif
        @if($sld['t'] != 0)
            <tr>
                <td style="background: #eaeaea" colspan="6" align="left">Tipe: TARIK   Penarikan</td>
            </tr>
            @foreach($simpanan as $value)
                @if($value['tipe'] == "TARIK")
                    <tr>
            ...
            @endforeach
            <tr><td colspan="6" align="right">----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</td></tr>
            <tr><td colspan="6" align="right">{!! number_format($t,2 ,'.', ',') !!}</td></tr>
        @endif
        @if($sld['x'] != 0)
            <tr>
                <td style="background: #eaeaea" colspan="6" align="left">Tipe: TRANSFER   Transfer / Pindah Buku</td>
            </tr>
            @foreach($simpanan as $value)
            ...
            @endforeach
            <tr><td colspan="6" align="right">----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</td></tr>
            <tr><td colspan="6" align="right">{!! number_format($x,2 ,'.', ',') !!}</td></tr>
        @endif
        @if($sld['y'] != 0)
            <tr>
                <td style="background: #eaeaea" colspan="6" align="left">Tipe: TPINJAMAN   Bayar Pinjaman</td>
            </tr>
            @foreach($simpanan as $value)
            ...
            @endforeach
            <tr><td colspan="6" align="right">----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</td></tr>
            <tr><td colspan="6" align="right">{!! number_format($y,2 ,'.', ',') !!}</td></tr>
        @endif
    </tbody>
    <tfoot>
        <tr>
