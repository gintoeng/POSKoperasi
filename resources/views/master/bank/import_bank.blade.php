        ...
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="post" enctype="multipart/form-data" action="{!! url('master/bank/import') !!}" id="fimpbnk">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type='text' readonly class='form-control' value='Sheet 1 : KODE | NAMA_BANK'>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <ul>
                                            <li>KODE : Kode bank misalnya DNM</li>
                                            <li>NAMA_BANK : Nama bank misalnya Danamon</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <a href="{!! url('master/bank/import/sample') !!}" class="btn btn-warning btn-block"><i class="ti-download mr5"></i>Sample</a>
                                    </div>
                                    <div class="col-sm-2">
