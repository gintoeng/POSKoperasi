        ...
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="post" action="{!! url('master/bank') !!}" id="fbank">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="nama_bank" type="text" class="form-control" id="nama" placeholder="Nama bank" required>
                                    </div>
                                </div>
                                <div class="form-group">
