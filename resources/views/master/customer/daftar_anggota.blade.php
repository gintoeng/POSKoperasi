                        ...
                        <div class="col-md-12">
                            <form class="form-inline" role="form" method="get" action="{{ url('master/customer/search') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="query" type="text" class="form-control" placeholder="Cari customer" id="cari">
                                </div>
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    @foreach($anggota as $value)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center text-{{$stat}}">{!! $value->status !!}</td>
