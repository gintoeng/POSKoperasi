...
<script>
    ...
    function doc(id) {
        $('#tabdoc').load("{{url('master/customer/attach/doc')}}/" + id);
        $('#formdoc').attr('action', '{{ url('master/customer/attach') }}');
        $('#idp').val(id);
        $('#reModal').modal();
    }
    ...
    function hapus(id) {
        $('#tabdoc').load("{{url('master/customer/attach/destroy')}}/" + id + "/" + $('#idp').val());
    }

    function down(id) {
        window.open("{{url('master/customer/attach/download')}}/" + id);
    }

    function pre(id) {
        window.open("{{url('master/customer/attach/preview')}}/" + id);
    }
