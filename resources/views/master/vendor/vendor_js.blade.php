...
<script>
        ...
        $.ajax({
            ...
            success:function(data)
            {
                if (data[0]["stat"] == "FAIL") {
                    ...
                    if (btn == "tambah") {
                        location.href = "{!! url('master/vendor/create') !!}";
                    } else {
                        location.href = "{!! url('master/vendor/import') !!}";
                    }
                }
            }
    ...
    function konfirm(id) {
        swal({
                    ...
                    text: "Data Barang yg berasal dari Vendor ini juga akan Terhapus !",
                    type: "warning",
            ...
            location.href =  "{{ url('master/vendor') }}/" + id + "/destroy";
        })
