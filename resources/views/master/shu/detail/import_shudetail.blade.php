        ...
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="post" enctype="multipart/form-data" action="{!! url('master/katshudetail/import') !!}" id="fimpshud">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type='text' readonly class='form-control' value='Sheet 1 : KD_HEADER | NAMA | PERSEN | FIELD'>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <ul>
                                            <li>KD_HEADER : Kode dari Kelompok SHU</li>
                                            <li>NAMA : Nama SHU misalnya Simpanan Pokok</li>
                                            <li>PERSEN : Persentase dapat SHU</li>
                                            <li>FIELD : Field yg diambil untuk persentase SHU</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <a href="{!! url('master/katshudetail/import/sample') !!}" class="btn btn-warning btn-block"><i class="ti-download mr5"></i>Sample</a>
                                    </div>
                                    <div class="col-sm-2">
