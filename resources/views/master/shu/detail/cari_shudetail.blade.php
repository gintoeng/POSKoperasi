                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form-inline" role="form" method="get" action="{{ url('master/katshudetail/search') }}">
                                <div class="form-group mr5">
                                    ...
                                    <input name="query" type="text" class="form-control" placeholder="Cari shu" value="{{ $query }}" id="cari">
                                </div>
                                    ...
                                    @foreach($shudetail as $value)
                                        <tr>
                                            ...
                                            @if($value->masuk_shu == 0)
                                                <td class="text-danger">SHU</td>
                                            @else
                                                <td class="text-primary">SHU</td>
                                            @endif
...
{{--                                        {!! str_replace('?','?query='.$query.'&',$unit->links()) !!}--}}
                                        {!! $shudetail->appends(['query' => $query])->links() !!}
                                    </div>
                                </div>
                            </div>
                        </div>
