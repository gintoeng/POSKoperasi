...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">{!! $shudetail->kode !!}</li>
    </ol>
    <div class="row">
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="post" action="{!! url('master/katshudetail/'.$shudetail->id.'/update') !!}" id="fshud">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="id_header" class="form-control" id="idheader" data-placeholder="Kelompok SHU" style="width: 100%">
                                            ...
                                            @foreach($header as $item)
                                                <option value="{!! $item->id !!}" {{$shudetail->id_header == $item->id ? 'selected' : ''}}>{!! $item->kode !!} - {!! $item->nama !!}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="nama" type="text" class="form-control" id="nama" value="{!! $shudetail->nama !!}" placeholder="Nama" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="spinner input-group">
                                            <input name="percent" type="text" class="form-control input-sm spinner-input" id="percent" value="{!! $shudetail->percent !!}" placeholder="Persen">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="checkbox">
                                            <label><input name="menerima_shu" type="checkbox" value="1" id="shu" {{$shudetail->masuk_shu == "1" ? 'checked' : ''}}>&nbsp;(Masuk SHU)</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="field" type="text" class="form-control" id="field" value="{!! $shudetail->fieldnya !!}" placeholder="Field" required>
                                    </div>
                                </div>
                                <div class="form-group">
