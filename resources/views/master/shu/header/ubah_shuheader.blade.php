...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">{!! $shuheader->kode !!}</li>
    </ol>
    <div class="row">
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="post" action="{!! url('master/katshuheader/'.$shuheader->id.'/update') !!}" id="fshuh">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="kode" type="text" class="form-control" id="kode" placeholder="Kode" value="{!! $shuheader->kode !!}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="namaunit" class="col-sm-3 control-label">Nama</label>
                                    <div class="col-sm-9">
                                        <input name="nama" type="text" class="form-control" id="nama" placeholder="Nama Unit" value="{!! $shuheader->nama !!}" required>
                                    </div>
                                </div>
                                <div class="form-group">
