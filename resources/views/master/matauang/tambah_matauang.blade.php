        ...
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="post" action="{!! url('master/matauang') !!}" id="fmat">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="nama" type="text" class="form-control" id="nama" placeholder="Nama Mata Uang" required>
                                    </div>
                                </div>
                                <div class="form-group icheck">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="checkbox">
                                            <label><input name="def" type="checkbox" value="1">&nbsp;Set Default</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
