...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">{!! $recab->kode !!}</li>
    </ol>
    <div class="row">
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="post" action="{!! url('master/cabangrekening/'.$recab->id.'/update') !!}" id="frecab">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="kode" type="text" class="form-control" id="kode" placeholder="Kode" value="{!! $recab->kode !!}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="namaunit" class="col-sm-3 control-label">Nama Cabang Rekening</label>
                                    <div class="col-sm-9">
                                        <input name="nama" type="text" class="form-control" id="nama" placeholder="Nama Cabang Rekening" value="{!! $recab->nama !!}" required>
                                    </div>
                                </div>
                                <div class="form-group">
