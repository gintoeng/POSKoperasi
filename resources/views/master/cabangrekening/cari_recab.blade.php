                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form-inline" role="form" method="get" action="{{ url('master/cabangrekening/search') }}">
                                <div class="form-group mr5">
                                    ...
                                    <input name="query" type="text" class="form-control" placeholder="Cari cabang rekening" value="{{ $query }}" id="cari">
                                </div>
                                <input type="hidden" name="search" value="1">
                                <button type="submit" class="btn btn-sm btn-primary"><i class="ti ti-search"> Cari</i></button>
                                <a href="{!! url('master/cabangrekening') !!}"><button type="button" class="btn btn-color btn-sm"><i class="ti ti-reload"> Reset</i></button></a>
                            </form>
                        </div>
                    </div>
...
{{--                                        {!! str_replace('?','?query='.$query.'&',$unit->links()) !!}--}}
                                        {!! $recab->appends(['query' => $query])->links() !!}
                                    </div>
                                </div>
                            </div>
                        </div>
