...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{!! url('pengaturan/role') !!}">Daftar Hak User</a></li>
    </ol>
    <div class="row">
        <div class="col-md-12">
            <section class="panel no-b">
                <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form-inline" role="form" method="get" action="{{ url('pengaturan/role/search') }}">
                                <div class="form-group mr5">
                                    ...
                                    <input name="query" type="text" class="form-control" placeholder="Cari hak akses" id="cari" value="{{ $query }}">
                                </div>
                                <input type="hidden" name="search" value="1">
                                <button type="submit" class="btn btn-sm btn-primary"><i class="ti ti-search"> Cari</i></button>
                                <a href="{!! url('pengaturan/role') !!}"><button type="button" class="btn btn-color btn-sm"><i class="ti ti-reload"> Reset</i></button></a>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="pull-right">
                                {!! str_replace('?','?query='.$query.'&',$role->links()) !!}
                            </div>
                        </div>
                    </div>
                        </div>
