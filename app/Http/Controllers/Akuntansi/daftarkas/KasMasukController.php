...
class KasMasukController extends Controller
{
     ...
     */
     ...
     {
         $nom = Nomor::where('modul', 'Kas Masuk')->first();
    ...
    public function index()
    {
        ...
        return view('Akuntansi.daftarkas.kasmasuk')->with('date', $date)
    ...
    {
        $msg = "Berhasil! <br> Anda berhasil menambahkan data Kas Masuk";
        $alert = Toastr::success($msg, $title = "Tambah Kas Masuk", $options = []);
        ...
        $JurnalDetail->debet = '0';
        $JurnalDetail->kredit = str_replace(',', '', $r->jumlah);
        ...
        for ($i=0; $i < count($r['nominal']); $i++) {
            ...
            $detail->debet = str_replace(',', '', $r['nominal'][$i]);
            $detail->kredit = '0';
        ...
        return redirect(url('akuntansi/kasmasuk'))
            ->with('alert', $alert);
    }
